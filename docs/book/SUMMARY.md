...
- [Target workspace](architecture/workspace.md)
- [Crate boundaries](architecture/crate-boundaries.md)
- [Technology targets](architecture/technology.md)
...
- [Vulkan crate and ownership model](architecture/decisions/vulkan-crate.md)
- [Platform window lifecycle](architecture/decisions/window-lifecycle.md)
- [ECS adoption](architecture/decisions/ecs-adoption.md)
- [Physics strategy](architecture/decisions/physics-strategy.md)
- [Audio strategy](architecture/decisions/audio-strategy.md)
...
- [Builder and typestate](patterns/builder-typestate.md)
- [Events and message passing](patterns/events.md)

# Practices

- [Project structure](practices/project-structure.md)
- [Error handling](practices/error-handling.md)
- [Testing and doctests](practices/testing.md)
- [Public APIs and dependencies](practices/public-apis.md)
- [Dependency management](practices/dependencies.md)
- [Performance and observability](practices/performance.md)

# Examples

- [Example policy](examples/index.md)

# References

- [Curated links](references/curated-links.md)
