...
pub use crate::render::{
    ...
    LodReadout, MASK_EDGE_WIDTH, MAX_CHUNK_VERTICES, MeshPool, PoolConfig, PoolStats,
    PushAtmosphere, PushMatrix, PushTex, PushTransform, RIM_COLOR, RIM_FADE_END, RIM_MAX_ALPHA,
    RIM_POWER, SCATTER_COLOR, SCATTER_FADE_END, SCATTER_FADE_START, SCATTER_MAX_ALPHA,
    SCATTER_RISE_END, SKY_COLOR, STRIPE_BANDS, ShellVertex, TEX_FRAG, TEX_VERT, TEXT_FRAG,
    TEXT_VERT, TexVertexGpu, VisibilityReadout, appearance, atmosphere_lines,
    atmosphere_state_name, checker, checkerboard_mips, chunk_bounds, clip_planes, compile_spirv,
    compute_chunk_vertices, culling_camera, device_type_rank, diffuse, dome_weight, draw_camera,
    edge_mask, flattening_lines, fly_speed, fresnel, gradient, latitude, lod_lines,
    mip_level_count, morph_vertex, morphed_chunk_bounds, overlay_lines, panel_item_at,
    pixel_matrix, player_marker_vertices, pool_lines, radial_rgb, required_capacity, rim_factor,
    rim_weight, rings, scatter_weight, scenario_index_of, shell_vertices, stripes,
    visibility_lines,
};
pub use crate::scene::{
